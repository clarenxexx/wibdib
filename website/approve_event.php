...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['id'])) {
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        $sql_check_approvals = "SELECT admin_approval, dean_approval, staff_approval 
        ...
        if ($row_check_approvals['admin_approval'] && $row_check_approvals['dean_approval'] && $row_check_approvals['staff_approval']) {
